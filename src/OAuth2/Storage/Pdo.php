    ...
    OpenIDAuthorizationCodeInterface
{
    ...
    public function __construct($connection, $config = array())
    {
        ...
        $this->config = array_merge(array(
            'client_table' => 'dsc_oauth_clients',
            'access_token_table' => 'dsc_oauth_access_tokens',
            'refresh_token_table' => 'dsc_oauth_refresh_tokens',
            'code_table' => 'dsc_oauth_authorization_codes',
            'user_table' => 'dsc_oauth_users',
            'jwt_table'  => 'dsc_oauth_jwt',
            'jti_table'  => 'dsc_oauth_jti',
            'scope_table'  => 'dsc_oauth_scopes',
            'public_key_table'  => 'dsc_oauth_public_keys',
        ), $config);
    }
